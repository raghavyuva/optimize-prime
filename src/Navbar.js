...
export let Navbar = () => {
    ...
    return(
        <div className="min-h-full" >
            <nav className="pattern2 bg-gradient-to-r from-purple-500 via-purple-300 to-blue-500 ">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between align-middle h-20">

                            <div className="flex-shrink-0">
                              <p className="text-2xl text-gray-400 font-serif"> Cipher Control Panel</p>
                            </div>
